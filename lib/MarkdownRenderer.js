...
class MarkdownHelper {
  ...
  headingRenderer(props) {
    switch (props.level) {
      case 1:
        return <Typography variant="h3" gutterBottom component="h1" style={{ textAlign: 'left', clear: 'both' }} key={props.nodeKey}>{props.children}</Typography>;
      case 2:
        return <Typography variant="h4" gutterBottom component="h2" style={{ textAlign: 'left', clear: 'both' }} key={props.nodeKey}>{props.children}</Typography>;
      case 3:
        return <Typography variant="h5" gutterBottom component="h3" style={{ clear: 'both' }} key={props.nodeKey}>{props.children}</Typography>;
      case 4:
        return <Typography variant="h6" gutterBottom component="h4" style={{ textAlign: 'left', clear: 'both' }} key={props.nodeKey}>{props.children}</Typography>;
      case 5:
        return <Typography variant="subtitle1" gutterBottom component="h5" style={{ textAlign: 'left', clear: 'both' }} key={props.nodeKey}>{props.children}</Typography>;
      case 6:
        return <Typography variant="body1" gutterBottom component="h6" style={{ textAlign: 'left', clear: 'both' }} key={props.nodeKey}>{props.children}</Typography>;
      default:
        return <Typography variant="body2" gutterBottom style={{ textAlign: 'left', clear: 'both' }} key={props.nodeKey}>{props.children}</Typography>;
    }
  }
